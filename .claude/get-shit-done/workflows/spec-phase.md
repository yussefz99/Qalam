...
```bash
INIT=$(node "/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/templates/spec.md.
