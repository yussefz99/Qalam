...
```
Agent(
  prompt="Read /Users/mareekhalila/Documents/Qalam/qalam/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/templates/VALIDATION.md`
