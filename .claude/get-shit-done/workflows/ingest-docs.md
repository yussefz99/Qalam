...
```bash
INIT=$(node "/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
