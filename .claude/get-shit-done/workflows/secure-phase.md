...
```
Agent(
  prompt="Read /Users/mareekhalila/Documents/Qalam/qalam/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/templates/SECURITY.md`
