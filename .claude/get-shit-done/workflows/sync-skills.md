...
INSTALL_JS_GLOBAL="/Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mareekhalila/Documents/Qalam/qalam/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
